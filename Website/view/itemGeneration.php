...
class itemGeneration {
  function cardTemplate($productName, $productPrice, $productImage, $productDescription, $productId) : string {
    return '
    <div class="col">
      <div class="card ">
...
<a href="javascript:void(0)" class="show-description-btn  bg-transparent pl-0  text-decoration-none text-muted text-1"
       style="text-decoration: none ;">Show Description</a>          
          ...
          <div class="input-group pl-0 mb-3 col-sm-5">
            ...
            <input type="text" class="form-control form-control-sm quantitySelector text-center" value="1" aria-label="Quantity">
  ...
  function cardTemplateSingle($productName, $productPrice, $productImage, $productDescription, $productId) : string {
    return '
  ...
  public function displaySingleProduct($product, $productPerRow = 1) : void {
    $output = '';
